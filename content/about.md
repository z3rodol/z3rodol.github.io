...
<div class="cert-item" style="flex: 0 0 auto; text-align: center;">
  <h3 style="color: #3498db; margin-bottom: 10px;"></h3>
  <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
    {{< image src="/images/certifications/dante.png" caption="Dante" height="180" width="180" >}}
    {{< image src="/images/certifications/heron.png" caption="Heron" height="180" width="180" >}}
    {{< image src="/images/certifications/poo.png" caption="POO" height="180" width="180" >}}
  </div>
</div>

<div class="cert-item" style="flex: 0 0 auto; text-align: center;">
  <h3 style="color: #e74c3c; margin-bottom: 10px;"></h3>
  <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
    {{< image src="/images/certifications/tea.png" caption="Tea" height="180" width="180" >}}
    {{< image src="/images/certifications/intercept.png" caption="Intercept" height="180" width="180" >}}
    {{< image src="/images/certifications/tengu.png" caption="Tengu" height="180" width="180" >}}
  </div>
</div>
...
- **Hackthebox** : https://app.hackthebox.com/profile/1587799
